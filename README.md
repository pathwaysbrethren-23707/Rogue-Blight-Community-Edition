...
# 🎮 Rogue Blight — Community Edition

**Fight the spreading blight through shifting dungeons.**
...
Rogue Blight is a dark-fantasy roguelite in which players descend through procedurally generated dungeons consumed by a spreading corruption. This Community Edition is a standalone build that runs entirely offline and requires no storefront or additional software. The package is self-contained and ready to play immediately after installation.

Players who want a complete, self-contained roguelite experience on Windows with no additional software required.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1890310/5c294c20153dc417fd00d4c0fa1794a901ddeeba/ss_5c294c20153dc417fd00d4c0fa1794a901ddeeba.1920x1080.jpg?t=1788451526" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1890310/7945dc1f04bc1cdf51aaf3cbcdf8ca5b5438d512/ss_7945dc1f04bc1cdf51aaf3cbcdf8ca5b5438d512.1920x1080.jpg?t=1788451526" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1890310/475236d8343011a9556ab57761ea114a87bfa04c/ss_475236d8343011a9556ab57761ea114a87bfa04c.1920x1080.jpg?t=1788451526" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, French, German, Spanish, Portuguese-Brazil, Russian, Simplified Chinese, Japanese, Korean
- **Voiceover:** English
...
- 🗡️ **Procedural Dungeons** — Every run generates new layouts, enemy placements, and loot.
- 🦠 **Blight Mechanic** — A spreading corruption reshapes zones and enemy behavior as runs progress.
- ⚔️ **Multiple Classes** — Distinct characters with unique weapons, skills, and playstyles.
- 💀 **Permadeath Runs** — Permanent run consequences balanced by meta-progression between attempts.
- 🧪 **Build Crafting** — Combine relics, curses, and upgrades to discover powerful synergies.
- 👑 **Boss Encounters** — Handcrafted bosses guarding the most corrupted regions.
- 🎮 **Controller Support** — Full gamepad support alongside keyboard and mouse input.
- 🖥️ **Offline Play** — The complete experience runs without an internet connection.

- **Compression:** Lossless
- **Install Time:** ~3 minutes on SSD, ~8 minutes on HDD
- **Recoding:** none
- **Selective Download:** Soundtrack and language packs can be skipped during setup to reduce install size
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | GeForce GTX 750 Ti / Radeon RX 560, 2 GB VRAM | GeForce GTX 1060 / Radeon RX 580, 6 GB VRAM |
| **Storage** | 6 GB available space | 6 GB on a solid state drive |
| **Additional** | DirectX 11 compatible system | Solid state drive for faster installation and load times |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\RogueBlight\Saved`
